...
let NuspecFiles = ["Plugin.Nfc.nuspec"] 
...
Target "build" (fun _ ->
    ...
    Build("Plugin.Nfc", "pcl")
    Build("Plugin.Nfc.NotImplemented", "null")
    Build("Plugin.Nfc.Android", "android")
    Build("Plugin.Nfc.iOS", "ios")
    Build("Plugin.Nfc.UWP", "uwp")
)

...
namespace Plugin.Nfc
{
	public partial class CrossNfc
	{
		...
		public static void SetCurrentActivityResolver(Func<Activity> activityResolver) => _activityResolver = activityResolver;

		public static void OnNewIntent(Intent intent) => ((NfcImplementation)Current).CheckForNfcMessage(intent);
